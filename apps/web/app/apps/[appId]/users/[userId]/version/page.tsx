        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>确认发布版本到用户</CardDescription>
            </CardHeader>
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              确定要将版本 <strong>{selectedVersion?.version}</strong> 发布给用户{" "}
              <strong>{user?.userId || user?.deviceId || "-"}</strong> 吗？
              <br />
              <br />
              发布类型：<strong>定向发布（仅推送给当前用户）</strong>
              <br />
